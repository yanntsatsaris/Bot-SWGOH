...
GAC_FLEETS = {
    "CAPITALLEVIATHAN": {
        "members": ["CAPITALLEVIATHAN", "FURYCLASSINTERCEPTOR", "SITHBOMBER", "SITHFIGHTER", "MKVIINTERCEPTOR", "TIEDAGGER", "SITHINFILTRATOR", "SITHASSASSIN", "EBONHAWK"],
        "defense": 10
    },
    "CAPITALEXECUTOR": {
        "members": ["CAPITALEXECUTOR", "PUNISHINGONE", "RAZORCREST", "HOUNDSTOOTH", "XANADUBLOOD", "SLAVE1", "IG2000", "EBONHAWK"],
        "defense": 10
    },
    "CAPITALPROFUNDITY": {
        "members": ["CAPITALPROFUNDITY", "MILLENNIUMFALCON", "OUTRIDER", "YWINGREBEL", "GHOST", "PHANTOM2", "CASSIANSUWING", "BISTANSUWING", "BWINGREBEL"],
        "defense": 8
    },
    "CAPITALNEGOTIATOR": {
        "members": ["CAPITALNEGOTIATOR", "JEDISTARFIGHTERANAKIN", "UMBARANSTARFIGHTER", "YWINGCLONEWARS", "MARAUDER", "BLADEOFDORIN", "JEDISTARFIGHTERAHSOKATANO", "ARC170REX", "ARC170CLONESERGEANT", "JEDISTARFIGHTERCONSULAR"],
        "defense": 8
    },
    "CAPITALMALEVOLENCE": {
        "members": ["CAPITALMALEVOLENCE", "VULTUREDROID", "HYENABOMBER", "GEONOSIANSTARFIGHTERSUNFAC", "GEONOSIANSTARFIGHTERSPY", "GEONOSIANSTARFIGHTER", "IG2000", "EBONHAWK"],
        "defense": 7
    },
    "CAPITALCHIMAERA": {
        "members": ["CAPITALCHIMAERA", "TIEDEFENDER", "TIEINTERCEPTOR", "TIEADVANCED", "TIEBOMBER", "TIEFIGHTER", "GAUNTLETSTARFIGHTER", "EMPERORSSHUTTLE"],
        "defense": 6
    },
    "CAPITALSTARDESTROYER": {
        "members": ["CAPITALSTARDESTROYER", "TIEDEFENDER", "TIEINTERCEPTOR", "TIEADVANCED", "TIEBOMBER", "TIEFIGHTER", "GAUNTLETSTARFIGHTER", "EMPERORSSHUTTLE"],
        "defense": 5
    },
    "CAPITALFINALIZER": {
        "members": ["CAPITALFINALIZER", "TIESILENCER", "FIRSTORDER_ECHELON", "KYLORENSCOMMANDSHUTTLE", "FIRSTORDERSPECIALFORCESTIEFIGHTER", "FIRSTORDERTIEFIGHTER", "HOUNDSTOOTH", "EBONHAWK"],
        "defense": 3
    },
    "CAPITALRADDUS": {
        "members": ["CAPITALRADDUS", "REYSMILLENNIUMFALCON", "RESISTANCEYWING", "POEDAMERONXWING", "XWINGRESISTANCE", "COMEUPPANCE", "EBONHAWK"],
        "defense": 5
    },
}
